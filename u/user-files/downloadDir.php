...
if(!isset($_GET['dirName'])){
    header("Location:http://drive.hosted-kabeersnetwork.unaux.com");
}
...
$url = 'http://drive.hosted-kabeersnetwork.unaux.com/u/0/userDirDownload/'.$_SESSION['username'].'-'.$dirName.'.zip';
